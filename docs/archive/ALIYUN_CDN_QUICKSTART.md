...
3. **添加 CNAME 记录**
   ...
   **记录 1**（根域名）：
   ...
   记录类型：CNAME
   主机记录：@
   记录值：yiruoai.com.w.kunlunle.com（使用实际分配的 CNAME）
   TTL：10 分钟
   ```
